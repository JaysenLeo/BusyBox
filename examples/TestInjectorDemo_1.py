# -*- coding: utf-8 -*-
import abc
from BusyBox import Box, FactoryInjectAPI, factory_inject
from logging import info
box = Box()


class AppleServiceAPI(metaclass=abc.ABCMeta):
...
class AppleServiceFactory(FactoryInjectAPI):

    def construct(self, *args, **kwargs) -> AppleServiceAPI:
        return AppleService()


class AppleService(AppleServiceAPI):
